...
<body>
  <div class="toolbar">
    ...
    <div class="tool-buttons">
      ...
      <button id="btn-profiles" class="tool-btn profile-btn" title="Perfiles">&#x1F464; Perfil</button>
  ...
  <div id="clean-panel" class="panel hidden">
    <div class="panel-header">
      <h3>Limpiar Datos (perfil actual)</h3>
  ...
  <!-- Panel de perfiles -->
  <div id="profiles-panel" class="panel hidden">
    <div class="panel-header">
      <h3>Perfiles</h3>
      <button id="close-profiles-panel" class="close-btn">&times;</button>
    </div>
    <div class="panel-body">
      <div class="profile-create">
        <input type="text" id="new-profile-name" placeholder="Nombre del perfil..." class="profile-input">
        <button id="btn-create-profile" class="action-btn">+ Crear</button>
      </div>
      <div id="profiles-list" class="profiles-list"></div>
      <p class="profile-note">Cada perfil guarda sus cookies y sesiones por separado.</p>
    </div>
  </div>

  <!-- Panel de fingerprint -->
  <div id="fp-panel" class="panel hidden">
    ...
    <div class="panel-body">
      <div id="network-info" class="network-info">
        <div class="fp-row"><span class="fp-label">IP Publica</span><span class="fp-value" id="info-ip">Cargando...</span></div>
        <div class="fp-row"><span class="fp-label">DNS</span><span class="fp-value" id="info-dns">Cargando...</span></div>
      </div>
  ...
  <div class="status-bar">
    ...
    <span id="profile-badge" class="profile-badge" title="Perfil activo">Perfil: <span id="current-profile-name">default</span></span>
