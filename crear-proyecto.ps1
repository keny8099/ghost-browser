# Ghost Browser - Script de creacion de proyecto
...
@'
{
  "name": "ghost-browser",
  "version": "1.0.0",
  "description": "Navegador anti-fingerprint con rotacion de canvas, fingerprint y limpieza de datos",
  "main": "main.js",
  "scripts": {
    "start": "electron .",
  ...
  "build": {
    "appId": "com.ghost.browser",
    "productName": "Ghost Browser",
    "directories": {
      "output": "dist"
    },
    "win": {
...
Write-Host "Parte 1 completada: package.json, .gitignore, preload.js, main.js" -ForegroundColor Green
